  ...
  <section class="grid grid-cols-2 min-h-screen">
    <div class="bg-white flex items-center justify-center relative">
      ...
      <div class="w-[80%] text-center">
        ...
        <h1 class="text-2xl font-semibold mb-10">REGISTER USER</h1>
        ...
        <form action="" method="POST">
          <div class="grid grid-cols-2 gap-5">
            ...
            <div class="relative">
              <input type="text" id="nama" name="name" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer border" placeholder=" " />
